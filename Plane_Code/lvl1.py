...
while user_lifes > 0 and pc_lifes > 0:
    reset_values()
    ...
    #ACTIONS
        ...
        #if pc_lifes <= 1:
         #   computer_choice = random.choice(act_options)
    ...
    #Quick Learning AI Enemy
    if rock_use == 2 and att_options.count("P") < 3:
        print("you are using ROCK too much... be careful")
        time.sleep(1)
        att_options.append("P")
        att_options.append("P")

    if paper_use == 2 and att_options.count("S") < 3:
        print("you are using PAPER too much... be careful")
        time.sleep(1)
        att_options.append("S")
        att_options.append("S")

    if scissor_use == 2 and att_options.count("R") < 3:
        print("you are using PAPER too much... be careful")
        time.sleep(1)
        att_options.append("R")
        att_options.append("R")
    ...
    if user_lifes == 0:
        print("\n__________________YOU DIED________________")

    elif pc_lifes == 0:
        print("\n______________________YOU WON!___________________")